...
?>
  ...
  <?php if (!$keyword) { ?>
    <div class="notification notification-warning"><?php echo PerchLang::get('To analyse your page, please set a keyword.'); ?></div>
  <?php } ?>

  <?php if ($error) { ?>
    <div class="notification notification-alert"><?php echo PerchLang::get($error); ?></div>
  <?php } ?>
  ...
  <div class="smartbar">
      <ul>
        <li>
          ...
          <li>
            <a href="<?php echo $blog_url; ?>" title="View Page" class="viewext">
