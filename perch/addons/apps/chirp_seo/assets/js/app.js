...
project.trafficLights = function(element) {
  var $score = $(element);

  var data = {
    lighttype: $score.data("type"),
    url: $score.data("url"), 
  }

  $.ajax({
    url: $(element).data("path") + '/lib/ajax/trafficlight.php',
    type: 'GET',
    data: data,
    success: function(data){ 
      $score.removeClass("loading").addClass(data.light);
    },
