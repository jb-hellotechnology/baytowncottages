<?php
    ...
    if (isset($message)){ 
	    ...
	    if (PerchUtil::count($unit)) {
			...
			echo $HTML->heading3('Add Unit Pricing');
		    ...
		    echo $Form->select_field('minStay','Min. Stay',$staylist);
			...
			$changelist[] = array('label'=>"Sat/Tue", 'value'=>'Sat/Tue');
		    $changelist[] = array('label'=>"Any Day", 'value'=>'Any Day');
		    echo $Form->select_field('changeOver','Changeover',$changelist);
		    ...
		    echo $Form->text_field("onenight","1 Night");
		    echo $Form->text_field("twonights","2 Night");
		    echo $Form->text_field("threenights","3 Night");
		    echo $Form->text_field("fournights","4 Night");
		    echo $Form->text_field("fivenights","5 Night");
		    echo $Form->text_field("sixnights","6 Night");
		    echo $Form->text_field("sevennights","7 Night");
			...
			echo $Form->submit_field('btnSubmit', 'Add Unit Pricing', $API->app_path());
