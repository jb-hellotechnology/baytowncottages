<?php
    ...
    if (isset($message)){ 
		...
		echo $HTML->heading3('Add an Email');
		
		echo $Form->form_start();
		
		echo $Form->text_field("subject","Subject",'');
		
		echo $Form->textarea_field("content","Content",'');
	
		echo $Form->submit_field('btnSubmit', 'Add Email', $API->app_path());
